...
const AttachmentModal = (props) => {
    ...
    const { data: attachmentsData, refetch } = useQuery({queryKey: [attachment], queryFn: () => request({ url: attachment, params: { search, sort: sorting, paginate: paginate, page } }), enabled: false, refetchOnWindowFocus: false, select: (data) => data?.data });
    useEffect(() => {
