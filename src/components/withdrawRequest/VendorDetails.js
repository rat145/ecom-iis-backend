...
const VendorDetails = () => {
    ...
    const { data, isLoading, refetch } = useQuery({queryKey: [VendorTransations, role], queryFn: () => request({ url: VendorTransations }), enabled: false, refetchOnWindowFocus: false, select: (data) => data.data });
    useEffect(() => {
